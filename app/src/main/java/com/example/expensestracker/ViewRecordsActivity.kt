                ...
                bottomBar = {
                    ...
                    BottomAppBar(backgroundColor = Color(0xFFadbef4),
                        ...
                        content = {
                            ...
                            {
                                Text(
                                    text = "Set Limit", color = Color.Magenta, fontSize = 14.sp,
                                    textAlign = TextAlign.Center
                                )
                            }
...
fun Records(items: List<Items>) {
    Text(text = "expense history", modifier = Modifier.padding(top = 24.dp, start = 106.dp, bottom = 24.dp ), fontSize = 30.sp, fontWeight = FontWeight.Bold)
            ...
            LazyColumn {
                items(items) { items ->
                    Column(modifier = Modifier.padding(top = 16.dp, start = 48.dp, bottom = 20.dp)) {
                        Text("name of item: ${items.itemName}")
                        Text("Quantity of item: ${items.quantity}")
                        Text("cost of item: ${items.cost}")
                    }
                }
            }
        }
